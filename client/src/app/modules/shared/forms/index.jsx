...
export const DateRange = (register, label, name, leftName, rightName, leftDate, rightDate, note) => (
    <Form.Group controlId={name}>
        <Form.Label>{label}</Form.Label>
                ...
                <div style={{ width: '50%', marginRight: '5px' }}>
                    <Form.Control 
                        ...
                        onChange={(e) => {
                            ...
                            const currentLeftSecs = parseInt(getValues(leftNames.secs)) || 0;
                ...
                <div style={{ width: '50%', marginLeft: '5px' }} >
                    <Form.Control                                     
                        ...
                        onChange={(e) => {
                            ...
                            const currentLeftMins = parseInt(getValues(leftNames.mins)) || 0;
            ...
            <div style={{ display: 'flex', width: '47%' }}>
                ...
                <div style={{ width: '50%', marginRight: '5px' }}>
                    <Form.Control                
                        ...
                        onChange={(e) => {
                            const mins = parseInt(e.target.value) || 0;
                            const currentRightSecs = parseInt(getValues(rightNames.secs)) || 0;
                ...
                <div style={{ width: '50%', marginLeft: '5px' }} >
                    <Form.Control                                   
                        ...
                        onChange={(e) => {
                            const secs = parseInt(e.target.value) || 0;
                            const currentRightMins = parseInt(getValues(rightNames.mins)) || 0;
